...
if __name__ == "__main__":
    ...
    gimbal_pub = rospy.Publisher('cmd_gimbal_angle', GimbalAngle, queue_size=1)
        ...
        while(1):
            ...
            if key in moveBindings.keys():
                ...
                position_yaw = position_yaw + \
                    cradleHead_angle_delta*cradleHeadBindings[key][0]
                position_pitch = position_pitch + \
                    cradleHead_angle_delta*cradleHeadBindings[key][1]
            ...
            gimbalAngle.pitch_angle = position_pitch
            gimbalAngle.yaw_angle = position_yaw
            gimbal_pub.publish(gimbalAngle)
